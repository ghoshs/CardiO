...
```
nohup python -m utils.api_request_parallel_processor \
  --requests_filepath data/requests/cardio_sent_filter_requests.jsonl 
  --save_filepath data/sent_filter_responses/cardio_sent_filter_results.jsonl 
  --request_url https://api.openai.com/v1/chat/completions 
  --max_requests_per_minute 4000 
  --max_tokens_per_minute 100000 
  --api_key YOUR_API_KEY >> data/output/api_req.out &
...
async def process_api_requests_from_file(
    ...
    with open(requests_filepath) as file:
        ...
        requests = islice(file, restart, None)
